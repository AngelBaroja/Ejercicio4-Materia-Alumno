...
public class Pantalla extends javax.swing.JFrame {
    ...
    public Pantalla(HashSet<Materia> listaMateria,HashSet<Alumno> listaAlumno) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FormularioMaterias formularioMateria = new FormularioMaterias(listaMateria,listaAlumno);
        formularioMateria.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        FormularioAlumno formularioAlumno = new FormularioAlumno(listaMateria, listaAlumno);
        formularioAlumno.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        FormularioInscripcion fi = new FormularioInscripcion(listaMateria, listaAlumno);
        fi.setVisible(true);
        dispose();
